...
class __TwigTemplate_4b6247d985181d4ab3ef8381a8fee01a849016d6dbf4cf4cccfe88db7d0103d1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <form method=\"post\" id=\"tblchartform\" action=\"";
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 72
            echo "                        ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["idx"]] ?? null) : null), "type", [], "any", false, false, false, 72), ($context["numeric_types"] ?? null))) {
                // line 73
                echo "                            ";
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 84
            echo "                        ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, (($__internal_compile_1 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["idx"]] ?? null) : null), "type", [], "any", false, false, false, 84), ($context["date_time_types"] ?? null))) {
                // line 85
                echo "                            ";
                echo twig_escape_filter($this->env, ($context["idx"] . " "), "html", null, true);
                echo "
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 90
            echo "                        ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, (($__internal_compile_2 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2[$context["idx"]] ?? null) : null), "type", [], "any", false, false, false, 90), ($context["numeric_types"] ?? null))) {
                // line 91
                echo "                            ";
                echo twig_escape_filter($this->env, ($context["idx"] . " "), "html", null, true);
                echo "
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 132
            echo "                        ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, (($__internal_compile_4 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[$context["idx"]] ?? null) : null), "type", [], "any", false, false, false, 132), ($context["numeric_types"] ?? null))) {
                // line 133
                echo "                            ";
...
";
    ...
    {
        return new Source("", "table/chart/tbl_chart.twig", "C:\\xampp\\htdocs\\dblocal\\templates\\table\\chart\\tbl_chart.twig");
    }
}
