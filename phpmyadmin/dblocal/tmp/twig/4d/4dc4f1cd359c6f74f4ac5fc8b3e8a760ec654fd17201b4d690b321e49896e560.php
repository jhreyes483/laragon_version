...
class __TwigTemplate_1402c970bee5edcc83a2ed824c0a5fe853baa61fbdf0adfe5914de46bc2fa8f7 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <select name=\"master_connection\">
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["server"]) {
                ...
                echo "\"";
                echo (((($context["master_connection"] ?? null) == (($__internal_compile_1 = $context["server"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["Connection_name"] ?? null) : null))) ? (" selected") : (""));
                echo ">
            ";
                // line 12
...
($context["has_slave_configure"] ?? null)) {
            ...
            // line 103
            echo twig_sprintf($___internal_parse_0_, (((("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/server/replication")) . "\" data-post=\"") . PhpMyAdmin\Url::getCommon(twig_array_merge(($context["url_params"] ?? null), ["sl_configure" => true, "repl_clear_scr" => true]), "", false)) . "\">"), "</a>");
            // line 109
            echo "  ";
        }
        // line 110
...
";
    ...
    {
        return new Source("", "server/replication/slave_configuration.twig", "C:\\xampp\\htdocs\\dblocal\\templates\\server\\replication\\slave_configuration.twig");
    }
}
