...
class __TwigTemplate_96687be44964ec92b063b2a58935d2a42e31eafc7bc5bddcb71aec977951e082 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["master_configure"] ?? null)) && (null === ($context["clear_screen"] ?? null)))) {
        ...
        ";
                ...
                // line 20
                echo twig_sprintf($___internal_parse_0_, (((("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/server/replication")) . "\" data-post=\"") . PhpMyAdmin\Url::getCommon(twig_array_merge(($context["url_params"] ?? null), ["mr_configure" => true]), "", false)) . "\">"), "</a>");
                // line 25
                echo "        </div>
      </div>
    ";
...
";
    ...
    {
        return new Source("", "server/replication/index.twig", "C:\\xampp\\htdocs\\dblocal\\templates\\server\\replication\\index.twig");
    }
}
