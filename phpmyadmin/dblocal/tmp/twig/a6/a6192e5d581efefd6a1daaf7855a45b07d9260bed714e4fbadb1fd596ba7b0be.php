...
class __TwigTemplate_36eb4f07c6cf2748a122d41033d4f66352472c60ef163260f775a1f9b70ef36b extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["tmp_initial"] => $context["initial_was_found"]) {
            ...
            if ( !($context["tmp_initial"] === null)) {
                ...
                if ($context["initial_was_found"]) {
                    ...
                    <a class=\"ajax";
                    // line 8
                    echo (((array_key_exists("initial", $context) && (($context["initial"] ?? null) === $context["tmp_initial"]))) ? (" active") : (""));
                    // line 9
                    echo "\" href=\"";
...
";
    ...
    {
        return new Source("", "server/privileges/initials_row.twig", "C:\\xampp\\htdocs\\dblocal\\templates\\server\\privileges\\initials_row.twig");
    }
}
